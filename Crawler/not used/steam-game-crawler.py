...
def getgamepages(timeout, maxretries, pause, out):
    #baseurl = 'https://store.steampowered.com/search/re?sort_by=_ASC&sort_order=ASC&page='
    baseurl= 'https://store.steampowered.com/search/?term=+Nier%3A+Automata&page='
    page = 1
    ...
    while True:
        ...
        if htmlpage is None:
            ...
            with open(os.path.join(pagedir, 'games-page-%s.html' % page), mode='w', encoding='utf-8-sig') as f:
                f.write(htmlpage)
