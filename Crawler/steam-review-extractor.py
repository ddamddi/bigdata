        ...
        for root, _, files in os.walk(basepath):
            ...
            for file in files:
                ...
                with open(fullpath, encoding='utf-8-sig') as f:
                    try:
                        soup = BeautifulSoup(json.loads(f.read())[
                                             'html'], "html.parser")
                    except ValueError:
                    ...
                    for reviewdiv in soup.findAll('div', attrs={'class': 'review_box'}):
                        ...
                        owned = 0
                        elem = reviewdiv.find(
                            'div', attrs={'class': 'num_owned_games'})
                        if elem:
